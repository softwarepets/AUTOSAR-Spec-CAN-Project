...
C_DEPS += \
./vglite/VGLiteKernel/vg_lite_kernel.d 

OBJS += \
./vglite/VGLiteKernel/vg_lite_kernel.o 


# Each subdirectory must supply rules for building sources it contributes
vglite/VGLiteKernel/%.o: ../vglite/VGLiteKernel/%.c vglite/VGLiteKernel/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-vglite-2f-VGLiteKernel

clean-vglite-2f-VGLiteKernel:
	-$(RM) ./vglite/VGLiteKernel/vg_lite_kernel.d ./vglite/VGLiteKernel/vg_lite_kernel.o

.PHONY: clean-vglite-2f-VGLiteKernel
