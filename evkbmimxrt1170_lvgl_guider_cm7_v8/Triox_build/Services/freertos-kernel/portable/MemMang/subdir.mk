...
C_SRCS += \
../Services/freertos-kernel/portable/MemMang/heap_4.c 

C_DEPS += \
./Services/freertos-kernel/portable/MemMang/heap_4.d 

OBJS += \
./Services/freertos-kernel/portable/MemMang/heap_4.o 


# Each subdirectory must supply rules for building sources it contributes
Services/freertos-kernel/portable/MemMang/%.o: ../Services/freertos-kernel/portable/MemMang/%.c Services/freertos-kernel/portable/MemMang/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-Services-2f-freertos-2d-kernel-2f-portable-2f-MemMang

clean-Services-2f-freertos-2d-kernel-2f-portable-2f-MemMang:
	-$(RM) ./Services/freertos-kernel/portable/MemMang/heap_4.d ./Services/freertos-kernel/portable/MemMang/heap_4.o

.PHONY: clean-Services-2f-freertos-2d-kernel-2f-portable-2f-MemMang
