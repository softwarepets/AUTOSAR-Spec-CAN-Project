...
C_DEPS += \
./source/application/can_pix/can.d 

OBJS += \
./source/application/can_pix/can.o 


# Each subdirectory must supply rules for building sources it contributes
source/application/can_pix/%.o: ../source/application/can_pix/%.c source/application/can_pix/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-application-2f-can_pix

clean-source-2f-application-2f-can_pix:
	-$(RM) ./source/application/can_pix/can.d ./source/application/can_pix/can.o

.PHONY: clean-source-2f-application-2f-can_pix
