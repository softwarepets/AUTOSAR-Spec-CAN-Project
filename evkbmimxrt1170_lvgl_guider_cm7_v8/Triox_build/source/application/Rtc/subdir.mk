...
C_SRCS += \
../source/application/Rtc/rtc.c 

C_DEPS += \
./source/application/Rtc/rtc.d 

OBJS += \
./source/application/Rtc/rtc.o 


# Each subdirectory must supply rules for building sources it contributes
source/application/Rtc/%.o: ../source/application/Rtc/%.c source/application/Rtc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-application-2f-Rtc

clean-source-2f-application-2f-Rtc:
	-$(RM) ./source/application/Rtc/rtc.d ./source/application/Rtc/rtc.o

.PHONY: clean-source-2f-application-2f-Rtc
