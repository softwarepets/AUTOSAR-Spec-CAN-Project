...
int baseScreen_clusterTime_BLE_min_value = 0;
int baseScreen_clusterTime_BLE_hour_value = 0;
int baseScreen_clusterTime_BLE_sec_value = 0;

void setTime(int hours, int minutes, int seconds)	{
	baseScreen_clusterTime_BLE_min_value = minutes;
	baseScreen_clusterTime_BLE_hour_value = hours;
	baseScreen_clusterTime_BLE_sec_value = seconds;
}
...
void setup_scr_baseScreen(lv_ui *ui)
{
	...
	lv_obj_set_style_opa(ui->baseScreen_controllerIndicationContainer, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	ui->baseScreen_PhoneBattery= lv_img_create(ui->baseScreen_statusBarWidget);
	lv_obj_add_flag(ui->baseScreen_PhoneBattery, LV_OBJ_FLAG_CLICKABLE);
	lv_img_set_src(ui->baseScreen_PhoneBattery, &_batteryTooLowIcon_alpha_50x50);
	lv_img_set_pivot(ui->baseScreen_PhoneBattery, 50,50);
	lv_img_set_angle(ui->baseScreen_PhoneBattery, 0);
	lv_obj_set_pos(ui->baseScreen_PhoneBattery, 300, 0);
	lv_obj_set_size(ui->baseScreen_PhoneBattery, 50, 50);

	//Write style for baseScreen_PhoneBatteryEmpty, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_img_opa(ui->baseScreen_PhoneBattery, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes baseScreen_phoneNetworkSignal0
	ui->baseScreen_phoneNetworkSignal = lv_img_create(ui->baseScreen_statusBarWidget);
	lv_obj_add_flag(ui->baseScreen_phoneNetworkSignal, LV_OBJ_FLAG_CLICKABLE);
	lv_img_set_src(ui->baseScreen_phoneNetworkSignal, &_Signal0Icon_alpha_50x50);
	lv_img_set_pivot(ui->baseScreen_phoneNetworkSignal, 50,50);
	lv_img_set_angle(ui->baseScreen_phoneNetworkSignal, 0);
	lv_obj_set_pos(ui->baseScreen_phoneNetworkSignal, 240, 0);
	lv_obj_set_size(ui->baseScreen_phoneNetworkSignal, 50, 50);

	//Write style for baseScreen_phoneNetworkSignal0, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_img_opa(ui->baseScreen_phoneNetworkSignal, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes baseScreen_menuWidget
	ui->baseScreen_menuWidget = lv_obj_create(ui->baseScreen);
	lv_obj_set_style_opa(ui->baseScreen_menuWidget, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_img_opa(ui->baseScreen_Document, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->baseScreen_resetButton, lv_color_hex(0x00A0EE), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->baseScreen_menuHeading, lv_color_hex(0XFCCD26), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->baseScreen_speedometerValue, 0, 210);
	...
	lv_obj_set_pos(ui->baseScreen_batteryValueGroup, 180, 35);
	...
	lv_obj_set_style_opa(ui->baseScreen_phoneCall_Navigation, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	ui->baseScreen_callAcceptRejectInfo = lv_label_create(ui->baseScreen_PhoneCall);
	lv_label_set_text(ui->baseScreen_callAcceptRejectInfo, "hi");
	lv_label_set_long_mode(ui->baseScreen_callAcceptRejectInfo, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->baseScreen_callAcceptRejectInfo, 170, 540);
	lv_obj_set_size(ui->baseScreen_callAcceptRejectInfo, 660, 50);

	//Write style for baseScreen_callTime, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->baseScreen_callAcceptRejectInfo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->baseScreen_callAcceptRejectInfo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->baseScreen_callAcceptRejectInfo, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->baseScreen_callAcceptRejectInfo, &lv_font_MIMXRT1170EVKB_50, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->baseScreen_callAcceptRejectInfo, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->baseScreen_callAcceptRejectInfo, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_line_space(ui->baseScreen_callAcceptRejectInfo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->baseScreen_callAcceptRejectInfo, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->baseScreen_callAcceptRejectInfo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->baseScreen_callAcceptRejectInfo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->baseScreen_callAcceptRejectInfo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->baseScreen_callAcceptRejectInfo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->baseScreen_callAcceptRejectInfo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->baseScreen_callAcceptRejectInfo, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_opa(ui->baseScreen_speedometerMenuWidget, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_opa(ui->baseScreen_batteryMenuWidget, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->baseScreen_firstWidget, 860, 111);
	...
	//Write codes baseScreen_widgetOneUnit
	ui->baseScreen_widgetOneUnit = lv_label_create(ui->baseScreen_firstWidget);
	lv_label_set_text(ui->baseScreen_widgetOneUnit, "km");
	lv_label_set_long_mode(ui->baseScreen_widgetOneUnit, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->baseScreen_widgetOneUnit, 40, 85);
	lv_obj_set_size(ui->baseScreen_widgetOneUnit, 320, 30);

	//Write style for baseScreen_widgetOneUnit, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->baseScreen_widgetOneUnit, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->baseScreen_widgetOneUnit, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->baseScreen_widgetOneUnit, lv_color_hex(0xAEAEAE), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->baseScreen_widgetOneUnit, &lv_font_MIMXRT1170EVKB_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->baseScreen_widgetOneUnit, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->baseScreen_widgetOneUnit, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_line_space(ui->baseScreen_widgetOneUnit, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->baseScreen_widgetOneUnit, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->baseScreen_widgetOneUnit, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->baseScreen_widgetOneUnit, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->baseScreen_widgetOneUnit, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->baseScreen_widgetOneUnit, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->baseScreen_widgetOneUnit, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->baseScreen_widgetOneUnit, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes baseScreen_widgetOneValue
	ui->baseScreen_widgetOneValue = lv_label_create(ui->baseScreen_firstWidget);
	lv_label_set_text(ui->baseScreen_widgetOneValue, "999");
	lv_label_set_long_mode(ui->baseScreen_widgetOneValue, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->baseScreen_widgetOneValue, 40, 35);
	lv_obj_set_size(ui->baseScreen_widgetOneValue, 320, 50);

	//Write style for baseScreen_widgetOneValue, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->baseScreen_widgetOneValue, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->baseScreen_widgetOneValue, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->baseScreen_widgetOneValue, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->baseScreen_widgetOneValue, &lv_font_MIMXRT1170EVKB_50, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->baseScreen_widgetOneValue, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->baseScreen_widgetOneValue, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_line_space(ui->baseScreen_widgetOneValue, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->baseScreen_widgetOneValue, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->baseScreen_widgetOneValue, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->baseScreen_widgetOneValue, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->baseScreen_widgetOneValue, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->baseScreen_widgetOneValue, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->baseScreen_widgetOneValue, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->baseScreen_widgetOneValue, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes baseScreen_widgetOneLabel
	ui->baseScreen_widgetOneLabel = lv_label_create(ui->baseScreen_firstWidget);
	lv_label_set_text(ui->baseScreen_widgetOneLabel, "Odometer");
	lv_label_set_long_mode(ui->baseScreen_widgetOneLabel, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->baseScreen_widgetOneLabel, 40, 5);
	lv_obj_set_size(ui->baseScreen_widgetOneLabel, 320, 30);

	//Write style for baseScreen_widgetOneLabel, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->baseScreen_widgetOneLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->baseScreen_widgetOneLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->baseScreen_widgetOneLabel, lv_color_hex(0x0093E7), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->baseScreen_widgetOneLabel, &lv_font_MIMXRT1170EVKB_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->baseScreen_widgetOneLabel, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->baseScreen_widgetOneLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_line_space(ui->baseScreen_widgetOneLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->baseScreen_widgetOneLabel, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->baseScreen_widgetOneLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->baseScreen_widgetOneLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->baseScreen_widgetOneLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->baseScreen_widgetOneLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->baseScreen_widgetOneLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->baseScreen_widgetOneLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
